...
/**
 * Created by barath on 11/13/2015.
 */

@DynamicUpdate
@Entity
@Table(name = "newTimings", uniqueConstraints = {
        @UniqueConstraint(columnNames = "settingsId")})
public class NewTimings {
    ...
    public ClinicDoctors getClinicDoctors() {
        return clinicDoctors;
    }

    public void setClinicDoctors(ClinicDoctors clinicDoctors) {
