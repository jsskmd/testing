 ...
 */
@Transactional
public interface AppointmentRepository extends CrudRepository<ConfirmAppointment, Long> {


    @Query("from ConfirmAppointment as d where d.clinicId=:clinicId and d.doctorId=:doctorId and d.date =:date and d.scheduledOn between current_timestamp and :before and d.tokenNo > :tokenNo")
    public List<ConfirmAppointment> getPatientToUpdateStatus(@Param(value = "clinicId") Long clinicId, @Param(value = "doctorId") Long doctorId, @Param(value = "date") String date, @Param(value = "before") Date before,@Param(value = "tokenNo") int tokenNo);
    ...
    @Query("from ConfirmAppointment as cd where cd.status <= 3 and cd.doctorId=:doctorId and cd.clinicId=:clinicId and  cd.cancelledOn between :before and :after")
    ...
    @Query("from ConfirmAppointment as d where d.clinicId=:clinicId and d.doctorId=:doctorId and d.date=:date and status = 0")
    public List<ConfirmAppointment> getCancelledSlotOnDate(@Param(value = "clinicId") Long clinicId, @Param(value = "doctorId") Long doctorId, @Param(value = "date") String date);


    @Query("from ConfirmAppointment as d where d.patientId=:patientId and d.scheduledOn < current_date and status > 3")
    ...
    @Query("from ConfirmAppointment as d where d.clinicId=:clinicId and d.doctorId=:doctorId and d.patientId=:patientId and d.status=4 and d.scheduledOn >:scheduledOn order by scheduledOn")
    public List<ConfirmAppointment> checkPatientAppSched(@Param(value = "clinicId") Long clinicId, @Param(value = "doctorId") Long doctorId, @Param(value = "patientId") Long patientId, @Param(value = "scheduledOn") Date scheduledOn);
    ...
    @Query("from ConfirmAppointment as d where d.clinicId=:clinicId and d.doctorId=:doctorId and d.date=:date")
    ...
    @Query("from ConfirmAppointment as d where d.clinicId=:clinicId and d.doctorId=:doctorId and d.date =:date and d.time =:time order by scheduledOn")
    ...
    public List<ConfirmAppointment> getDoctorBlocked(@Param(value = "clinicId") Long clinicId, @Param(value = "doctorId") Long doctorId, @Param(value = "date") String date);

    @Query("from ConfirmAppointment as d where d.clinicId=:clinicId and d.doctorId=:doctorId  and d.status=4 and d.scheduledOn >= :scheduledOn order by scheduledOn")
    public List<ConfirmAppointment> getAppSchedBasedOnDoctIdAndClinicId(@Param(value = "clinicId") Long clinicId, @Param(value = "doctorId") Long doctorId,@Param(value = "scheduledOn") Date scheduledOn);

    @Query("from ConfirmAppointment as d where d.clinicId=:clinicId and d.doctorId=:doctorId and d.status =0 and d.scheduledOn between :vacaStartDate and :vacaEndDate and (d.updatedBy = 'ROLE_DOCTOR' or d.updatedBy = 'ROLE_CLINIC')")
    public List<ConfirmAppointment> getCancelledSlotBetweenDate(@Param(value = "clinicId") Long clinicId, @Param(value = "doctorId") Long doctorId, @Param(value = "vacaStartDate") Date vacaStartDate, @Param(value = "vacaEndDate") Date vacaEndDate);
