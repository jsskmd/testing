...
<div class="topbar">
    <div class="container">
        <div class="top-info-contact pull-left col-md-6">Call Us Today 1800-425-3282 | 944-981-1444 <a href="mailto:support@datalife.in ">support@datalife.in</a> </div>
                            ...
                            <div class="col-md-12 no-padding">
                                <form name='loginForm' action="<c:url value='/j_spring_security_check'/>" method='POST'>
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <fieldset class="input-block">
                                            <input type="text" pattern="^[a-zA-Z0-9]+$" required="required" name="username"
                                ...
                                <form>
                                    <div class="col-md-6 col-sm-6 signup-border">
                                        ...
                                        <fieldset class="input-block">
                                            <div class="dropdown">
                                                <select class="dropdown-select"  id="signupType">
                                                    <option selected="" disabled="">Select User Type</option>
                                                    <option value="1">Subscriber</option>
                                                    <option value="2">Clinic</option>
                                                    <option value="3">Service Providers</option>
