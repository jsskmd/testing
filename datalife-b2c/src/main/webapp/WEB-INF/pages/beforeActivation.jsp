                                ...
                                <div class="col-md-12 no-padding">
                                    ...
                                    <div class="col-md-12 col-sm-12  signup-border">
                                        ...
                                        <div class="form-wizard">
                                            ...
                                            <p>Thank you for signing up with DataLife.
                                                Click activation link sent to your email to complete registration process.
                                            </p>
                                        </div>
                                        <p style="float: right;"><a href="/login" style="text-decoration: underline">Back to Sign in</a></p>
                                    </div>
