...
<head>
    ...
    <script type="text/javascript" src="resources/js/server/labDashboard.js"></script>
                        ...
                        <nav class="wsmenu slideLeft clearfix">
                            <ul class="mobile-sub wsmenu-list docotnav" id="dashboard_menu">
                               ...
                               <%-- <li><a id="lab_profile" class="active"><i class="icon-calendar hideicon"></i>Profile</a></li>--%>
                                <li><a id="lab_patientSearch"><i class="icon-search hideicon"></i>Patient Search </a></li>
                                <li><a id="lab_settings"><i class="icon-doc-1 hideicon"></i>Order Status</a></li>
                                <li><a id="lab_profile"><i class="icon-doc-1 hideicon"></i>Lab Profile</a></li>
