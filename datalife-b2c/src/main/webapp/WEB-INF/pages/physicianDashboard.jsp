        ...
        <div class="nav-width">
            ...
            <nav class="wsmenu slideLeft clearfix">
                <ul class="mobile-sub wsmenu-list" id="headerBar">
                    ...
                    <li><a class="active" id="search_patient"><i class="icon-group hideicon"></i>&nbsp;&nbsp; Patient Search </a></li>
                    <li><a class="" id="add_patient"><i class="icon-group hideicon"></i>&nbsp;&nbsp;Register New patient </a></li>
                    ...
                    <div class="basicdetails-modal mobile-verification-demo hide" id="otpdiv">
                        <form method="post" name="user" id="otpVerificationForm">
                            <fieldset class="input-block">
                                ...
                                <a href="/" id="ver_refresh" style="display: none;    margin-left: 28%;">To access click
                                    on
