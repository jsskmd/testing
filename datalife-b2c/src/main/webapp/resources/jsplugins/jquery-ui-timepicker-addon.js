!function (e) {
    ...
    if ($.ui.timepicker = $.ui.timepicker || {}, !$.ui.timepicker.version) {
        $.extend($.ui, {timepicker: {version: "1.5.3"}});
                    ...
                    T.isRTL = D, setTimeout(function () {
                        if (0 === g.find(".ui-slider-access").length) {
                            ...
                            e && g.find("table:visible").each(function () {
                                var t = $(this), i = t.outerWidth(), s = t.css(D ? "marginRight" : "marginLeft").toString().replace("%", ""), n = i - e, a = s * n / i + "%", r = {width: n, marginRight: 0, marginLeft: 0};
        ...
        }, _controls: {slider: {create: function (e, t, i, s, n, a, r) {
            var l = e._defaults.isRTL;
            return t.prop("slide", null).slider({orientation: "horizontal", value: l ? -1 * s : s, min: l ? -1 * a : n, max: l ? -1 * n : a, step: r, slide: function (t, s) {
        ...
        }}, select: {create: function (e, t, i, s, n, a, r) {
        ...
        var isEmptyObject = function (e) {
            ...
            return l > 1 ? {dateString: r.splice(0, l - a).join(i), timeString: r.splice(0, a).join(i)} : {dateString: e, timeString: ""}
        ...
        $.timepicker = new Timepicker, $.timepicker.timezoneOffsetString = function (e, t) {
            ...
            var r = !1;
            return"timepicker" === e && (r = !0, e = "datetimepicker"), $.fn[e].call(t, $.extend({timeOnly: r, onClose: function (e, t) {
                n($(this), i)
            }, onSelect: function (e) {
                a($(this), i, "minDate")
            }}, s, s.start)), $.fn[e].call(i, $.extend({timeOnly: r, onClose: function (e, i) {
                n($(this), t)
            }, onSelect: function (e) {
                a($(this), t, "maxDate")
