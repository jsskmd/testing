!function (t) {
    var e = function () {
        ...
        return e.mixin(n.prototype, {set: function (t, e) {
        ...
        }}), e.mixin(i.prototype, {add: function (t) {
        ...
        return o = s && window.JSON ? {_prefix: function (t) {
        ...
        return n.setMaxPendingRequests = function (t) {
            ...
            a.reset()
        }, e.mixin(n.prototype, {_get: function (t, e, n) {
            function i(e) {
        ...
        return e.mixin(n.prototype, {bootstrap: function (t) {
        ...
        function r(i) {
            var r, s;
            return s = {url: null, thumbprint: "", ttl: 864e5, filter: null, ajax: {}}, (r = i.prefetch || null) && (r = e.isString(r) ? {url: r} : r, r = e.mixin(s, r), r.thumbprint = n + r.thumbprint, r.ajax.type = r.ajax.type || "GET", r.ajax.dataType = r.ajax.dataType || "json", !r.url && t.error("prefetch requires url to be set")), r
        }
        ...
        function s(n) {
            ...
            var s, o;
            return o = {url: null, cache: !0, wildcard: "%QUERY", replace: null, rateLimitBy: "debounce", rateLimitWait: 300, send: null, filter: null, ajax: {}}, (s = n.remote || null) && (s = e.isString(s) ? {url: s} : s, s = e.mixin(o, s), s.rateLimiter = /^throttle$/i.test(s.rateLimitBy) ? r(s.rateLimitWait) : i(s.rateLimitWait), s.ajax.type = s.ajax.type || "GET", s.ajax.dataType = s.ajax.dataType || "json", delete s.rateLimitBy, delete s.rateLimitWait, !s.url && t.error("remote requires url to be set")), s
        }
    ...
    !function (n) {
        ...
        var l, d;
        return l = n.Bloodhound, d = {data: "data", protocol: "protocol", thumbprint: "thumbprint"}, n.Bloodhound = r, r.noConflict = function () {
            return n.Bloodhound = l, r
        }, r.tokenizers = i, e.mixin(r.prototype, {_loadPrefetch: function (e) {
            function n(t) {
    ...
    var c = function () {
        ...
        var i = "typeahead:";
        return e.mixin(n.prototype, {trigger: function (t) {
        ...
        var o;
        return o = {9: "tab", 27: "esc", 37: "left", 39: "right", 13: "enter", 38: "up", 40: "down"}, n.normalizeQuery = function (t) {
            return(t || "").replace(/^\s*/g, "").replace(/\s{2,}/g, " ")
        }, e.mixin(n.prototype, d, {_onBlur: function () {
        ...
        function r(t, n) {
            ...
            return{empty: t.empty && e.templatify(t.empty), header: t.header && e.templatify(t.header), footer: t.footer && e.templatify(t.footer), suggestion: t.suggestion || i}
        }
        ...
        return n.extractDatasetName = function (e) {
            ...
            return t(e).data(a)
        }, e.mixin(n.prototype, d, {_render: function (n, i) {
            function r() {
            ...
            function s() {
                ...
                var s, l;
                return s = t(c.suggestions).css(h.suggestions), l = e.map(i, r), s.append.apply(s, l), g.highlight && p({className: "tt-highlight", node: s[0], pattern: n}), s
            }
        ...
        return e.mixin(n.prototype, d, {_onSuggestionClick: function (e) {
            ...
            var e = null;
            return t.length && (e = {raw: g.extractDatum(t), value: g.extractValue(t), datasetName: g.extractDatasetName(t)}), e
        ...
        function n(n) {
            ...
            n = n || {}, n.input || t.error("missing input"), this.isActivated = !1, this.autoselect = !!n.autoselect, this.minLength = e.isNumber(n.minLength) ? n.minLength : 1, this.$node = i(n.input, n.withHint), r = this.$node.find(".tt-dropdown-menu"), s = this.$node.find(".tt-input"), o = this.$node.find(".tt-hint"), s.on("blur.tt", function (t) {
                ...
                t.preventDefault()
            }), this.eventBus = n.eventBus || new l({el: s}), this.dropdown = new m({menu: r, datasets: n.datasets}).onSync("suggestionClicked", this._onSuggestionClicked, this).onSync("cursorMoved", this._onCursorMoved, this).onSync("cursorRemoved", this._onCursorRemoved, this).onSync("opened", this._onOpened, this).onSync("closed", this._onClosed, this).onAsync("datasetRendered", this._onDatasetRendered, this), this.input = new f({input: s, hint: o}).onSync("focused", this._onFocused, this).onSync("blurred", this._onBlurred, this).onSync("enterKeyed", this._onEnterKeyed, this).onSync("tabKeyed", this._onTabKeyed, this).onSync("escKeyed", this._onEscKeyed, this).onSync("upKeyed", this._onUpKeyed, this).onSync("downKeyed", this._onDownKeyed, this).onSync("leftKeyed", this._onLeftKeyed, this).onSync("rightKeyed", this._onRightKeyed, this).onSync("queryChanged", this._onQueryChanged, this).onSync("whitespaceChanged", this._onWhitespaceChanged, this), this._setLanguageDirection()
        }

        function i(e, n) {
            var i, s, u, a;
            i = t(e), s = t(c.wrapper).css(h.wrapper), u = t(c.dropdown).css(h.dropdown), a = i.clone().css(h.hint).css(r(i)), a.val("").removeData().addClass("tt-hint").removeAttr("id name placeholder required").prop("readonly", !0).attr({autocomplete: "off", spellcheck: "false", tabindex: -1}), i.data(o, {dir: i.attr("dir"), autocomplete: i.attr("autocomplete"), spellcheck: i.attr("spellcheck"), style: i.attr("style")}), i.addClass("tt-input").attr({autocomplete: "off", spellcheck: !1}).css(n ? h.input : h.inputWithNoHint);
            try {
        ...
        var o = "ttAttrs";
        return e.mixin(n.prototype, {_onSuggestionClicked: function (t, e) {
            var n;
    ...
    !function () {
        "use strict";
        var n, i, r;
        n = t.fn.typeahead, i = "ttTypeahead", r = {initialize: function (n, r) {
            function s() {
                var s, o, u = t(this);
                e.each(r, function (t) {
                    t.highlight = !!n.highlight
                }), o = new y({input: u, eventBus: s = new l({el: u}), withHint: e.isUndefined(n.hint) ? !0 : !!n.hint, minLength: n.minLength, autoselect: n.autoselect, datasets: r}), u.data(i, o)
            }
